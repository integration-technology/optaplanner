...
package org.optaplanner.examples.golftour.swingui;
...
public class GolfTourPanel extends SolutionPanel {
    ...
    private class TeamAssignmentAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int result = JOptionPane.showConfirmDialog(GolfTourPanel.this.getRootPane(), listFieldsPanel,
